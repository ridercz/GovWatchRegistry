        ...
        protected override void Up(MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new {
                    ...
                    AltNames = table.Column<string>(nullable: true),
                    ...
                    OwnerEmailAddress = table.Column<string>(maxLength: 100, nullable: true),
                    OwnerPhoneNumber = table.Column<string>(maxLength: 100, nullable: true),
                ...
                constraints: table => {
                    ...
                    table.ForeignKey(
                        name: "FK_WebSites_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WebSites_AspNetUsers_UpdatedById",
